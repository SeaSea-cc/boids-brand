...
- All §4 Builder Ink rules apply to every slide

**Inputs:** Positioning source, MemU benchmark data, credit loop description, ICP messaging, layer-verb rules.
**Output:** A structured deck with cover, positioning, product map, credit loop, ICP tiers, competitive set, and CTA.

---

### 2. Single Marketing Image

**When:** LinkedIn post image, Twitter/X card, ad creative, blog hero.
...
- No more than 3 colors in play (Bone, Ink, Phosphor)
- Grain overlay at 3%
- No photography, no icons, no gradients
...
### 3. Long-form Social Post / Thread
...
- Social proof: MemU benchmarks (11.5k+ stars, 92.09% Locomo)
